      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <h1 className="text-lg font-semibold text-gray-900">DataKiln</h1>
          </div>
        </div>
        ...
        <div className="flex-1 max-w-lg mx-8 hidden lg:block">
          <div className="relative">
            <Input
              ...
              className="pl-10 pr-4 h-9 bg-gray-50 border-gray-200 focus:bg-white cursor-pointer"
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative" ref={userMenuRef}>
            ...
            {isUserMenuOpen && (
              <div
                className="absolute right-0 z-50 mt-2 w-56 rounded-md border border-gray-200 bg-white shadow-lg"
                role="menu"
              >
                <div className="px-4 py-3 border-b border-gray-200">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="font-medium text-sm text-gray-900">Local User</div>
